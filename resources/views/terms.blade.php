    ...
    <div class="col-8 mx-auto">
        <div class="p-2 bg-light">
            ...
            <div class="text-center mb-3">
                <a href="/"> <img src="{{asset('images/logo.png')}}" alt="Eumodelo" class="img-fluid" style="width: 300px;"></a>
            </div>

            <h1 class="fw-bold fs-3 mt-5">EMODELO TERMOS DE SERVIÇO</h1>
            <p class="fw-semibold">QUEM SOMOS</p>

            <p>
                <strong>EUMODELO TECNOLOGIA E EVENTOS LTDA</strong>, CNPJ 49.582.909/0001-94, com sede na Av. Portugal, n°1148, Sala C 2501 - Edifício Órion Business & Health Complex, Setor Marista, Goiânia-GO, CEP: 74.150-030, (“EUMODELO¨)
            </p>
            ...
            <p>
                ...
                "Conteúdo": refere-se a qualquer informação postada, compartilhada ou transmitida pelo usuário, incluindo textos, imagens, entre outros.
                "Propriedade intelectual": refere-se a qualquer direito relacionado à propriedade intelectual, incluindo direitos autorais, marcas registradas, patentes, segredos comerciais e outros direitos de propriedade intelectual.
            </p>
            ...
            <p>
                ...
                2.4 O usuário é responsável pela veracidade das informações fornecidas durante o cadastro eumodelo.
                2.5 O usuário se compromete a não compartilhar sua senha de acesso à eumodelo com terceiros e a manter seus dados atualizados.
                2.6 O usuário só poderá criar uma única conta eumodelo.
                2.7 A eumodelo se reserva o direito de suspender ou cancelar o acesso do usuário caso haja suspeita de violação das regras de uso ou de qualquer outra conduta inapropriada por parte do usuário.
                2.8 O usuário é responsável por todas as atividades realizadas em sua conta eumodelo e deverá notificar imediatamente a eumodelo caso suspeite de qualquer atividade não autorizada.
                2.9 A eumodelo não se responsabiliza por conteúdos publicados pelos usuários, mas se reserva o direito de remover conteúdos que violem as regras de uso da eumodelo ou que possam prejudicar a reputação da eumodelo.
                2.10 A eumodelo se reserva o direito de atualizar ou modificar as regras de uso a qualquer momento, sendo de responsabilidade do usuário consultar regularmente as regras de uso.
            ...
            <p>
                ...
                3.4 Processo de votação: para votar, os assinantes terão que escolher entre duas fotos aleatórias dos participantes e escolher a que mais gostar.
                3.5 Vencedores: os vencedores de cada concurso serão os participantes com mais votos ao final do concurso e serão exibidos no menu ¨Vencedores¨
                3.6 Desempate: em caso de empate, será dado um voto de desempate ao assinante mais antigo entre os empatados.
                3.7 Duração do concurso: o período de duração de cada concurso será informado aos usuários no menu "Concursos".
                3.8 Categorias: cada usuário será inscrito em uma categoria de acordo com as informações preenchidas ao se cadastrar na eumodelo. As categorias visam agrupar usuários com características semelhantes, por exemplo, bebês, crianças, adolescentes, adultos, idosos, etc.
                3.9 Premiação: a premiação para o primeiro, segundo e terceiro lugar será em dinheiro e enviada pelo PIX para o vencedor em até 5 dias úteis após o término do concurso.
                3.10 Notificações: os vencedores serão informados, no menu Notificação e por e-mail, sobre a vitória e sobre o envio do prêmio correspondente. Os demais participantes serão informados sobre a quantidade de votos que receberam no meu Notificação
                3.11 Desclassificação: a eumodelo se reserva o direito de desclassificar qualquer usuário que for identificado como tendo realizado atividades ilegais ou fraudulentas para obter vantagem no concurso.
                3.12 Informações incorretas: os participantes dos concursos de beleza têm a responsabilidade de fornecer informações precisas sobre seus dados PIX, para receberem a premiação. A eumodelo não se responsabiliza por informações incorretas fornecidas pelos vencedores que resultem na não entrega do prêmio.
                3.13 Regulamento: o Concurso de Beleza é regido pelos presentes Termos de Serviço, bem como pelos regulamentos adicionais publicados na eumodelo.
                3.14 Uso de imagem: ao se tornar um assinante, o usuário concorda em ceder os direitos de uso de imagem e voz para a eumodelo, para fins de divulgação e promoção do concurso.
            </p>
            ...
            <p>
                ...
                4.4 Os usuários são responsáveis por manter a segurança de suas contas e senhas de acesso à eumodelo, e por qualquer atividade que ocorra em sua conta.
                4.5 A eumodelo se reserva o direito de suspender ou encerrar as contas de usuários que violarem estes termos de serviço ou que apresentarem comportamento inadequado ou prejudicial à comunidade de usuários da eumodelo.
                4.6 Os usuários concordam em não utilizar a eumodelo para fins comerciais sem a devida autorização da eumodelo.
                4.7 Os usuários concordam em não criar contas falsas ou utilizar informações falsas ao criar seus perfis na eumodelo.
            </p>
            ...
            <p>
                ...
                5.4 A eumodelo não compartilhará dados pessoais dos usuários com terceiros, exceto quando necessário para cumprimento de obrigações legais ou regulatórias.
                5.5 Os usuários têm o direito de acessar, retificar ou excluir seus dados pessoais a qualquer momento, entrando em contato com a eumodelo.
                5.6 Ao utilizar a eumodelo, o usuário concorda com a coleta, uso e armazenamento de seus dados pessoais de acordo com esta política de privacidade.
            </p>
            ...
            <p>
                ...
                6.4 A eumodelo respeita os direitos autorais e propriedade intelectual de terceiros e espera que os usuários também o façam. Se você acredita que seus direitos autorais foram violados na eumodelo, entre em contato conosco informando as seguintes informações: (i) identificação do material protegido por direitos autorais; (ii) identificação do material que viola os direitos autorais; (iii) informações de contato para que possamos entrar em contato com você; (iv) uma declaração sua de que acredita de boa-fé que o uso do material em questão não é autorizado pelo proprietário dos direitos autorais, seus agentes ou pela lei; e (v) uma declaração sua de que as informações fornecidas na notificação são precisas e, sob pena de perjúrio, que você é o proprietário dos direitos autorais ou está autorizado a agir em nome do proprietário. A eumodelo investigará e tomará as medidas apropriadas em relação a reclamações de violação de direitos autorais.
            </p>
            ...
            <p>
                ...
                7.4 A eumodelo não se responsabiliza por quaisquer prejuízos decorrentes do uso de links externos disponibilizados na eumodelo, ou de quaisquer serviços ou produtos de terceiros.
                7.5 Em caso de conflito entre os usuários, a eumodelo não se responsabiliza pelas consequências e recomenda que os usuários busquem solucionar a questão entre si.
                7.6 Em caso de violação destes termos de serviço por parte do usuário, a eumodelo não se responsabiliza por quaisquer prejuízos que possam advir dessa violação, bem como se reserva o direito de tomar as medidas legais cabíveis.
            </p>
            ...
            <p>
                ...
                8.4 Em caso de rescisão do contrato, o usuário não terá direito a reembolso de eventuais pagamentos realizados à eumodelo, salvo em casos previstos por lei.
            </p>
            ...
            <p>
                ...
                9.4 Em caso de rescisão do contrato por parte da eumodelo, o usuário não terá direito a reembolso de eventuais pagamentos realizados à eumodelo.
                9.5 Em caso de rescisão do contrato por parte da eumodelo devido a descumprimento das regras de uso da eumodelo pelo usuário, o mesmo não terá direito a qualquer tipo de indenização.
