...
{{--                                                        </p>--}}
                                                    ...
                                                    @else
                                                        <p class="mt-2 fw-semibold">
                                                            We would like to let you know that you received <span class="fw-bold">{{(int)$winner['total_votes']}}</span> votes in <span class="fw-bold">{{$contest['contest_name']}}</span> . Congratulations on participating and showing your talent on our platform! Thanks again for your participation and we wish you success in your next competition!
                                                        </p>
